...
export async function createCheckEvent(
    ...
    return createEvent(
        ...
        minute,
        'check event',
        process.env.SCHEDULER_CHECK_CATEGORY_ID!,
        process.env.API_ENDPOINT + '/event-handler',
        'User-Id: ' + userId,
        '',
        'success',
        'failure',
...
export async function createNotificationEvent(
    ...
    return createEvent(
        ...
        minute,
        'notification event',
        process.env.SCHEDULER_NOTIFICATION_CATEGORY_ID!,
        process.env.API_ENDPOINT + '/event-handler',
        'User-Id: ' + userId,
        '',
        'success',
...
export async function createBackupEvent(
    ...
    return createEvent(
        ...
        minute,
        'backup event',
        process.env.SCHEDULER_BACKUP_CATEGORY_ID!,
        process.env.API_ENDPOINT + '/event-handler',
        'User-Id: ' + userId,
        '',
        'success',
