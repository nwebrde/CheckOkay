export function Google() {
    return <svg version="1.1" className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"
...
export function Apple() {
    return <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10" viewBox="4 32 376.4 449.4">
        <path
